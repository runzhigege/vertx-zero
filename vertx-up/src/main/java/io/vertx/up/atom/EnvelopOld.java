...
@Deprecated
public class EnvelopOld implements Serializable {
    ...
    private <T> EnvelopOld(final T data) {
     ...
     * @return
     */
    public static EnvelopOld ok() {
        return success(null);
    }

    public static <T> EnvelopOld success(final T entity) {
        return new EnvelopOld(entity);
    }
     ...
     * @return
     */
    public static EnvelopOld failure(final WebException error) {
        return new EnvelopOld(error);
    }
     ...
     * @return
     */
    public static <T> T data(final Message<EnvelopOld> message,
                             final Class<T> clazz) {
        final EnvelopOld body = message.body();
        if (null != body) {
    ...
    private EnvelopOld(final WebException error) {
