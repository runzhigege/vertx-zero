...
public interface IResHisConsume extends Serializable {

    /**
     * Setter for <code>DB_HTL.RES_HIS_CONSUME.PK_ID</code>. uniqueId,PK_ID
     */
    public IResHisConsume setPkId(String value);
     ...
     */
    public IResHisConsume setDAmount(BigDecimal value);
     ...
     */
    public IResHisConsume setDConsumeTime(LocalDateTime value);
     ...
     */
    public IResHisConsume setSCode(String value);
     ...
     */
    public IResHisConsume setSSerial(String value);
     ...
     */
    public IResHisConsume setJConfig(String value);
     ...
     */
    public IResHisConsume setRCardId(String value);
     ...
     */
    public IResHisConsume setIsFinished(Boolean value);
     ...
     */
    public IResHisConsume setIsActive(Boolean value);
     ...
     */
    public IResHisConsume setZSigma(String value);
     ...
     */
    public IResHisConsume setZLanguage(String value);
     ...
     */
    public IResHisConsume setZCreateBy(String value);
     ...
     */
    public IResHisConsume setZCreateTime(LocalDateTime value);
     ...
     */
    public IResHisConsume setZUpdateBy(String value);
     ...
     */
    public IResHisConsume setZUpdateTime(LocalDateTime value);
    ...
    /**
     * Load data from another generated Record/POJO implementing the common interface IResHisConsume
     */
    public void from(up.god.jooq.tables.interfaces.IResHisConsume from);

    /**
     * Copy data into another generated Record/POJO implementing the common interface IResHisConsume
     */
    public <E extends up.god.jooq.tables.interfaces.IResHisConsume> E into(E into);

    default IResHisConsume fromJson(io.vertx.core.json.JsonObject json) {
        setPkId(json.getString("PK_ID"));
        // Omitting unrecognized type java.math.BigDecimal for column D_AMOUNT!
        // Omitting unrecognized type java.time.LocalDateTime for column D_CONSUME_TIME!
