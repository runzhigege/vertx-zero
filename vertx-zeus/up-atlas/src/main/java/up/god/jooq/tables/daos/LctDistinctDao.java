...
public class LctDistinctDao extends DAOImpl<LctDistinctRecord, up.god.jooq.tables.pojos.LctDistinct, Long> implements VertxDAO<up.god.jooq.tables.records.LctDistinctRecord,up.god.jooq.tables.pojos.LctDistinct,java.lang.Long> {

    /**
     * Create a new LctDistinctDao without any configuration
     */
    public LctDistinctDao() {
        super(LctDistinct.LCT_DISTINCT, up.god.jooq.tables.pojos.LctDistinct.class);
    }
    ...
    public LctDistinctDao(Configuration configuration) {
        super(LctDistinct.LCT_DISTINCT, up.god.jooq.tables.pojos.LctDistinct.class, configuration);
    }
     ...
     */
    @Override
    protected Long getId(up.god.jooq.tables.pojos.LctDistinct object) {
     ...
     */
    public List<up.god.jooq.tables.pojos.LctDistinct> fetchByPkId(Long... values) {
     ...
     */
    public up.god.jooq.tables.pojos.LctDistinct fetchOneByPkId(Long value) {
     ...
     */
    public List<up.god.jooq.tables.pojos.LctDistinct> fetchBySName(String... values) {
     ...
     */
    public List<up.god.jooq.tables.pojos.LctDistinct> fetchBySCode(String... values) {
     ...
     */
    public List<up.god.jooq.tables.pojos.LctDistinct> fetchByJConfig(String... values) {
     ...
     */
    public List<up.god.jooq.tables.pojos.LctDistinct> fetchByIOrder(Integer... values) {
     ...
     */
    public List<up.god.jooq.tables.pojos.LctDistinct> fetchByRCityId(Long... values) {
     ...
     */
    public List<up.god.jooq.tables.pojos.LctDistinct> fetchByIsActive(Boolean... values) {
     ...
     */
    public List<up.god.jooq.tables.pojos.LctDistinct> fetchByZSigma(String... values) {
     ...
     */
    public List<up.god.jooq.tables.pojos.LctDistinct> fetchByZLanguage(String... values) {
     ...
     */
    public List<up.god.jooq.tables.pojos.LctDistinct> fetchByZCreateBy(String... values) {
     ...
     */
    public List<up.god.jooq.tables.pojos.LctDistinct> fetchByZCreateTime(LocalDateTime... values) {
     ...
     */
    public List<up.god.jooq.tables.pojos.LctDistinct> fetchByZUpdateBy(String... values) {
     ...
     */
    public List<up.god.jooq.tables.pojos.LctDistinct> fetchByZUpdateTime(LocalDateTime... values) {
     ...
     */
    public CompletableFuture<List<up.god.jooq.tables.pojos.LctDistinct>> fetchByPkIdAsync(List<Long> values) {
     ...
     */
    public CompletableFuture<up.god.jooq.tables.pojos.LctDistinct> fetchOneByPkIdAsync(Long value) {
     ...
     */
    public CompletableFuture<List<up.god.jooq.tables.pojos.LctDistinct>> fetchBySNameAsync(List<String> values) {
     ...
     */
    public CompletableFuture<List<up.god.jooq.tables.pojos.LctDistinct>> fetchBySCodeAsync(List<String> values) {
     ...
     */
    public CompletableFuture<List<up.god.jooq.tables.pojos.LctDistinct>> fetchByJConfigAsync(List<String> values) {
     ...
     */
    public CompletableFuture<List<up.god.jooq.tables.pojos.LctDistinct>> fetchByIOrderAsync(List<Integer> values) {
     ...
     */
    public CompletableFuture<List<up.god.jooq.tables.pojos.LctDistinct>> fetchByRCityIdAsync(List<Long> values) {
     ...
     */
    public CompletableFuture<List<up.god.jooq.tables.pojos.LctDistinct>> fetchByIsActiveAsync(List<Boolean> values) {
     ...
     */
    public CompletableFuture<List<up.god.jooq.tables.pojos.LctDistinct>> fetchByZSigmaAsync(List<String> values) {
     ...
     */
    public CompletableFuture<List<up.god.jooq.tables.pojos.LctDistinct>> fetchByZLanguageAsync(List<String> values) {
     ...
     */
    public CompletableFuture<List<up.god.jooq.tables.pojos.LctDistinct>> fetchByZCreateByAsync(List<String> values) {
     ...
     */
    public CompletableFuture<List<up.god.jooq.tables.pojos.LctDistinct>> fetchByZCreateTimeAsync(List<LocalDateTime> values) {
     ...
     */
    public CompletableFuture<List<up.god.jooq.tables.pojos.LctDistinct>> fetchByZUpdateByAsync(List<String> values) {
     ...
     */
    public CompletableFuture<List<up.god.jooq.tables.pojos.LctDistinct>> fetchByZUpdateTimeAsync(List<LocalDateTime> values) {
