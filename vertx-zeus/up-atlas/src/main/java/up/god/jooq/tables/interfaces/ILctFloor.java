...
public interface ILctFloor extends Serializable {
     ...
     */
    public ILctFloor setPkId(Long value);
     ...
     */
    public ILctFloor setRTentId(Long value);
     ...
     */
    public void from(up.god.jooq.tables.interfaces.ILctFloor from);

    /**
     * Copy data into another generated Record/POJO implementing the common interface ILctFloor
     */
    public <E extends up.god.jooq.tables.interfaces.ILctFloor> E into(E into);
