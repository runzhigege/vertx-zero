...
public class LctStateDao extends DAOImpl<LctStateRecord, up.god.jooq.tables.pojos.LctState, Long> implements VertxDAO<up.god.jooq.tables.records.LctStateRecord,up.god.jooq.tables.pojos.LctState,java.lang.Long> {

    /**
     * Create a new LctStateDao without any configuration
     */
    public LctStateDao() {
        super(LctState.LCT_STATE, up.god.jooq.tables.pojos.LctState.class);
    }
    ...
    public LctStateDao(Configuration configuration) {
        super(LctState.LCT_STATE, up.god.jooq.tables.pojos.LctState.class, configuration);
    }
     ...
     */
    @Override
    protected Long getId(up.god.jooq.tables.pojos.LctState object) {
     ...
     */
    public List<up.god.jooq.tables.pojos.LctState> fetchByPkId(Long... values) {
     ...
     */
    public up.god.jooq.tables.pojos.LctState fetchOneByPkId(Long value) {
     ...
     */
    public List<up.god.jooq.tables.pojos.LctState> fetchBySName(String... values) {
     ...
     */
    public List<up.god.jooq.tables.pojos.LctState> fetchBySCode(String... values) {
     ...
     */
    public List<up.god.jooq.tables.pojos.LctState> fetchBySAlias(String... values) {
     ...
     */
    public List<up.god.jooq.tables.pojos.LctState> fetchByJConfig(String... values) {
     ...
     */
    public List<up.god.jooq.tables.pojos.LctState> fetchByIOrder(Integer... values) {
     ...
     */
    public List<up.god.jooq.tables.pojos.LctState> fetchByRCountryId(Long... values) {
     ...
     */
    public List<up.god.jooq.tables.pojos.LctState> fetchByIsActive(Boolean... values) {
     ...
     */
    public List<up.god.jooq.tables.pojos.LctState> fetchByZSigma(String... values) {
     ...
     */
    public List<up.god.jooq.tables.pojos.LctState> fetchByZLanguage(String... values) {
     ...
     */
    public List<up.god.jooq.tables.pojos.LctState> fetchByZCreateBy(String... values) {
     ...
     */
    public List<up.god.jooq.tables.pojos.LctState> fetchByZCreateTime(LocalDateTime... values) {
     ...
     */
    public List<up.god.jooq.tables.pojos.LctState> fetchByZUpdateBy(String... values) {
     ...
     */
    public List<up.god.jooq.tables.pojos.LctState> fetchByZUpdateTime(LocalDateTime... values) {
     ...
     */
    public CompletableFuture<List<up.god.jooq.tables.pojos.LctState>> fetchByPkIdAsync(List<Long> values) {
     ...
     */
    public CompletableFuture<up.god.jooq.tables.pojos.LctState> fetchOneByPkIdAsync(Long value) {
     ...
     */
    public CompletableFuture<List<up.god.jooq.tables.pojos.LctState>> fetchBySNameAsync(List<String> values) {
     ...
     */
    public CompletableFuture<List<up.god.jooq.tables.pojos.LctState>> fetchBySCodeAsync(List<String> values) {
     ...
     */
    public CompletableFuture<List<up.god.jooq.tables.pojos.LctState>> fetchBySAliasAsync(List<String> values) {
     ...
     */
    public CompletableFuture<List<up.god.jooq.tables.pojos.LctState>> fetchByJConfigAsync(List<String> values) {
     ...
     */
    public CompletableFuture<List<up.god.jooq.tables.pojos.LctState>> fetchByIOrderAsync(List<Integer> values) {
     ...
     */
    public CompletableFuture<List<up.god.jooq.tables.pojos.LctState>> fetchByRCountryIdAsync(List<Long> values) {
     ...
     */
    public CompletableFuture<List<up.god.jooq.tables.pojos.LctState>> fetchByIsActiveAsync(List<Boolean> values) {
     ...
     */
    public CompletableFuture<List<up.god.jooq.tables.pojos.LctState>> fetchByZSigmaAsync(List<String> values) {
     ...
     */
    public CompletableFuture<List<up.god.jooq.tables.pojos.LctState>> fetchByZLanguageAsync(List<String> values) {
     ...
     */
    public CompletableFuture<List<up.god.jooq.tables.pojos.LctState>> fetchByZCreateByAsync(List<String> values) {
     ...
     */
    public CompletableFuture<List<up.god.jooq.tables.pojos.LctState>> fetchByZCreateTimeAsync(List<LocalDateTime> values) {
     ...
     */
    public CompletableFuture<List<up.god.jooq.tables.pojos.LctState>> fetchByZUpdateByAsync(List<String> values) {
     ...
     */
    public CompletableFuture<List<up.god.jooq.tables.pojos.LctState>> fetchByZUpdateTimeAsync(List<LocalDateTime> values) {
