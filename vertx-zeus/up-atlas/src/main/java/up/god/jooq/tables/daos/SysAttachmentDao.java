...
public class SysAttachmentDao extends DAOImpl<SysAttachmentRecord, up.god.jooq.tables.pojos.SysAttachment, Long> implements VertxDAO<up.god.jooq.tables.records.SysAttachmentRecord,up.god.jooq.tables.pojos.SysAttachment,java.lang.Long> {

    /**
     * Create a new SysAttachmentDao without any configuration
     */
    public SysAttachmentDao() {
        super(SysAttachment.SYS_ATTACHMENT, up.god.jooq.tables.pojos.SysAttachment.class);
    }
    ...
    public SysAttachmentDao(Configuration configuration) {
        super(SysAttachment.SYS_ATTACHMENT, up.god.jooq.tables.pojos.SysAttachment.class, configuration);
    }
     ...
     */
    @Override
    protected Long getId(up.god.jooq.tables.pojos.SysAttachment object) {
     ...
     */
    public List<up.god.jooq.tables.pojos.SysAttachment> fetchByPkId(Long... values) {
     ...
     */
    public up.god.jooq.tables.pojos.SysAttachment fetchOneByPkId(Long value) {
     ...
     */
    public List<up.god.jooq.tables.pojos.SysAttachment> fetchByBContent(byte[]... values) {
     ...
     */
    public List<up.god.jooq.tables.pojos.SysAttachment> fetchBySName(String... values) {
     ...
     */
    public List<up.god.jooq.tables.pojos.SysAttachment> fetchBySCode(String... values) {
     ...
     */
    public List<up.god.jooq.tables.pojos.SysAttachment> fetchBySType(String... values) {
     ...
     */
    public List<up.god.jooq.tables.pojos.SysAttachment> fetchByJConfig(String... values) {
     ...
     */
    public List<up.god.jooq.tables.pojos.SysAttachment> fetchByIsActive(Boolean... values) {
     ...
     */
    public List<up.god.jooq.tables.pojos.SysAttachment> fetchByZSigma(String... values) {
     ...
     */
    public List<up.god.jooq.tables.pojos.SysAttachment> fetchByZLanguage(String... values) {
     ...
     */
    public List<up.god.jooq.tables.pojos.SysAttachment> fetchByZCreateBy(String... values) {
     ...
     */
    public List<up.god.jooq.tables.pojos.SysAttachment> fetchByZCreateTime(LocalDateTime... values) {
     ...
     */
    public List<up.god.jooq.tables.pojos.SysAttachment> fetchByZUpdateBy(String... values) {
     ...
     */
    public List<up.god.jooq.tables.pojos.SysAttachment> fetchByZUpdateTime(LocalDateTime... values) {
     ...
     */
    public CompletableFuture<List<up.god.jooq.tables.pojos.SysAttachment>> fetchByPkIdAsync(List<Long> values) {
     ...
     */
    public CompletableFuture<up.god.jooq.tables.pojos.SysAttachment> fetchOneByPkIdAsync(Long value) {
     ...
     */
    public CompletableFuture<List<up.god.jooq.tables.pojos.SysAttachment>> fetchByBContentAsync(List<byte[]> values) {
     ...
     */
    public CompletableFuture<List<up.god.jooq.tables.pojos.SysAttachment>> fetchBySNameAsync(List<String> values) {
     ...
     */
    public CompletableFuture<List<up.god.jooq.tables.pojos.SysAttachment>> fetchBySCodeAsync(List<String> values) {
     ...
     */
    public CompletableFuture<List<up.god.jooq.tables.pojos.SysAttachment>> fetchBySTypeAsync(List<String> values) {
     ...
     */
    public CompletableFuture<List<up.god.jooq.tables.pojos.SysAttachment>> fetchByJConfigAsync(List<String> values) {
     ...
     */
    public CompletableFuture<List<up.god.jooq.tables.pojos.SysAttachment>> fetchByIsActiveAsync(List<Boolean> values) {
     ...
     */
    public CompletableFuture<List<up.god.jooq.tables.pojos.SysAttachment>> fetchByZSigmaAsync(List<String> values) {
     ...
     */
    public CompletableFuture<List<up.god.jooq.tables.pojos.SysAttachment>> fetchByZLanguageAsync(List<String> values) {
     ...
     */
    public CompletableFuture<List<up.god.jooq.tables.pojos.SysAttachment>> fetchByZCreateByAsync(List<String> values) {
     ...
     */
    public CompletableFuture<List<up.god.jooq.tables.pojos.SysAttachment>> fetchByZCreateTimeAsync(List<LocalDateTime> values) {
     ...
     */
    public CompletableFuture<List<up.god.jooq.tables.pojos.SysAttachment>> fetchByZUpdateByAsync(List<String> values) {
     ...
     */
    public CompletableFuture<List<up.god.jooq.tables.pojos.SysAttachment>> fetchByZUpdateTimeAsync(List<LocalDateTime> values) {
