...
public class LctTent implements ILctTent {
    ...
    private static final long serialVersionUID = 1380149672;
    ...
    @Override
    public LctTent setPkId(Long pkId) {
        this.pkId = pkId;
        return this;
    }
    ...
    @Override
    public LctTent setRLocationId(Long rLocationId) {
        this.rLocationId = rLocationId;
        return this;
    }
    ...
    @Override
    public LctTent setRYardId(Long rYardId) {
        this.rYardId = rYardId;
        return this;
    }
