...
public class LctFloor extends TableImpl<LctFloorRecord> {
    ...
    private static final long serialVersionUID = -2022403023;
     ...
     */
    public final TableField<LctFloorRecord, Long> PK_ID = createField("PK_ID", org.jooq.impl.SQLDataType.BIGINT.nullable(false).identity(true), this, "uniqueId,PK_ID");
     ...
     */
    public final TableField<LctFloorRecord, Long> R_TENT_ID = createField("R_TENT_ID", org.jooq.impl.SQLDataType.BIGINT, this, "tentId,R_TENT_ID");
     ...
     */
    @Override
    public Identity<LctFloorRecord, Long> getIdentity() {
        return Keys.IDENTITY_LCT_FLOOR;
    }
