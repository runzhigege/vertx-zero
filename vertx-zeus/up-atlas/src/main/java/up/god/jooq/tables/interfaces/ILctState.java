...
public interface ILctState extends Serializable {
     ...
     */
    public ILctState setPkId(Long value);
     ...
     */
    public ILctState setRCountryId(Long value);
     ...
     */
    public void from(up.god.jooq.tables.interfaces.ILctState from);

    /**
     * Copy data into another generated Record/POJO implementing the common interface ILctState
     */
    public <E extends up.god.jooq.tables.interfaces.ILctState> E into(E into);
