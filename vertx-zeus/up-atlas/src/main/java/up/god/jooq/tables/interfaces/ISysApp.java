...
public interface ISysApp extends Serializable {
     ...
     */
    public ISysApp setPkId(Long value);
     ...
     */
    public ISysApp setVEserverId(Integer value);
     ...
     */
    public void from(up.god.jooq.tables.interfaces.ISysApp from);

    /**
     * Copy data into another generated Record/POJO implementing the common interface ISysApp
     */
    public <E extends up.god.jooq.tables.interfaces.ISysApp> E into(E into);
    ...
    default ISysApp fromJson(io.vertx.core.json.JsonObject json) {
        ...
        setVEserverId(json.getInteger("V_ESERVER_ID"));
