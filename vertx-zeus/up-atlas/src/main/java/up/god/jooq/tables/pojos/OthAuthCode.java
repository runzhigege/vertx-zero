...
public class OthAuthCode implements IOthAuthCode {

    private static final long serialVersionUID = 600763160;
    ...
    public OthAuthCode(OthAuthCode value) {
    ...
    @Override
    public OthAuthCode setPkId(String pkId) {
        this.pkId = pkId;
        return this;
    }
    ...
    @Override
    public OthAuthCode setBAuth(byte... bAuth) {
        this.bAuth = bAuth;
        return this;
    }
    ...
    @Override
    public OthAuthCode setSCode(String sCode) {
        this.sCode = sCode;
        return this;
    }
    ...
    @Override
    public OthAuthCode setSState(String sState) {
        this.sState = sState;
        return this;
    }
    ...
    @Override
    public OthAuthCode setJConfig(String jConfig) {
        this.jConfig = jConfig;
        return this;
    }
    ...
    @Override
    public OthAuthCode setIsActive(Boolean isActive) {
        this.isActive = isActive;
        return this;
    }
    ...
    @Override
    public OthAuthCode setZSigma(String zSigma) {
        this.zSigma = zSigma;
        return this;
    }
    ...
    @Override
    public OthAuthCode setZLanguage(String zLanguage) {
        this.zLanguage = zLanguage;
        return this;
    }
    ...
    @Override
    public OthAuthCode setZCreateBy(String zCreateBy) {
        this.zCreateBy = zCreateBy;
        return this;
    }
    ...
    @Override
    public OthAuthCode setZCreateTime(LocalDateTime zCreateTime) {
        this.zCreateTime = zCreateTime;
        return this;
    }
    ...
    @Override
    public OthAuthCode setZUpdateBy(String zUpdateBy) {
        this.zUpdateBy = zUpdateBy;
        return this;
    }
    ...
    @Override
    public OthAuthCode setZUpdateTime(LocalDateTime zUpdateTime) {
        this.zUpdateTime = zUpdateTime;
        return this;
    }
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("OthAuthCode (");
    ...
    public OthAuthCode(io.vertx.core.json.JsonObject json) {
        fromJson(json);
    }
}
