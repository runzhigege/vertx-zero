...
public interface ILctLocation extends Serializable {
     ...
     */
    public ILctLocation setPkId(Long value);
     ...
     */
    public ILctLocation setRDistinctId(Long value);
     ...
     */
    public void from(up.god.jooq.tables.interfaces.ILctLocation from);

    /**
     * Copy data into another generated Record/POJO implementing the common interface ILctLocation
     */
    public <E extends up.god.jooq.tables.interfaces.ILctLocation> E into(E into);
