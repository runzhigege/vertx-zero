...
public class SysAppRecord extends UpdatableRecordImpl<SysAppRecord> implements ISysApp {
    ...
    private static final long serialVersionUID = -89380606;

    /**
     * Setter for <code>DB_HTL.SYS_APP.PK_ID</code>. uniqueId,PK_ID
     */
    @Override
    public SysAppRecord setPkId(Long value) {
        set(0, value);
        return this;
    }
     ...
     */
    @Override
    public SysAppRecord setVEserverId(Integer value) {
        set(2, value);
        return this;
    }
