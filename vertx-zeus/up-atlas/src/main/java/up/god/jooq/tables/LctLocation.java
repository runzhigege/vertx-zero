...
public class LctLocation extends TableImpl<LctLocationRecord> {
    ...
    private static final long serialVersionUID = 1696189093;
     ...
     */
    public final TableField<LctLocationRecord, Long> PK_ID = createField("PK_ID", org.jooq.impl.SQLDataType.BIGINT.nullable(false).identity(true), this, "uniqueId,PK_ID");
     ...
     */
    public final TableField<LctLocationRecord, Long> R_DISTINCT_ID = createField("R_DISTINCT_ID", org.jooq.impl.SQLDataType.BIGINT.nullable(false), this, "distinctId,R_DISTINCT_ID");
     ...
     */
    @Override
    public Identity<LctLocationRecord, Long> getIdentity() {
        return Keys.IDENTITY_LCT_LOCATION;
    }
