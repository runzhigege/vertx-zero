...
public class LctFloorDao extends DAOImpl<LctFloorRecord, up.god.jooq.tables.pojos.LctFloor, Long> implements VertxDAO<up.god.jooq.tables.records.LctFloorRecord,up.god.jooq.tables.pojos.LctFloor,java.lang.Long> {

    /**
     * Create a new LctFloorDao without any configuration
     */
    public LctFloorDao() {
        super(LctFloor.LCT_FLOOR, up.god.jooq.tables.pojos.LctFloor.class);
    }
    ...
    public LctFloorDao(Configuration configuration) {
        super(LctFloor.LCT_FLOOR, up.god.jooq.tables.pojos.LctFloor.class, configuration);
    }
     ...
     */
    @Override
    protected Long getId(up.god.jooq.tables.pojos.LctFloor object) {
     ...
     */
    public List<up.god.jooq.tables.pojos.LctFloor> fetchByPkId(Long... values) {
     ...
     */
    public up.god.jooq.tables.pojos.LctFloor fetchOneByPkId(Long value) {
     ...
     */
    public List<up.god.jooq.tables.pojos.LctFloor> fetchBySName(String... values) {
     ...
     */
    public List<up.god.jooq.tables.pojos.LctFloor> fetchBySCode(String... values) {
     ...
     */
    public List<up.god.jooq.tables.pojos.LctFloor> fetchByJConfig(String... values) {
     ...
     */
    public List<up.god.jooq.tables.pojos.LctFloor> fetchByIOrder(Integer... values) {
     ...
     */
    public List<up.god.jooq.tables.pojos.LctFloor> fetchByRTentId(Long... values) {
     ...
     */
    public List<up.god.jooq.tables.pojos.LctFloor> fetchByIsActive(Boolean... values) {
     ...
     */
    public List<up.god.jooq.tables.pojos.LctFloor> fetchByZSigma(String... values) {
     ...
     */
    public List<up.god.jooq.tables.pojos.LctFloor> fetchByZLanguage(String... values) {
     ...
     */
    public List<up.god.jooq.tables.pojos.LctFloor> fetchByZCreateBy(String... values) {
     ...
     */
    public List<up.god.jooq.tables.pojos.LctFloor> fetchByZCreateTime(LocalDateTime... values) {
     ...
     */
    public List<up.god.jooq.tables.pojos.LctFloor> fetchByZUpdateBy(String... values) {
     ...
     */
    public List<up.god.jooq.tables.pojos.LctFloor> fetchByZUpdateTime(LocalDateTime... values) {
     ...
     */
    public CompletableFuture<List<up.god.jooq.tables.pojos.LctFloor>> fetchByPkIdAsync(List<Long> values) {
     ...
     */
    public CompletableFuture<up.god.jooq.tables.pojos.LctFloor> fetchOneByPkIdAsync(Long value) {
     ...
     */
    public CompletableFuture<List<up.god.jooq.tables.pojos.LctFloor>> fetchBySNameAsync(List<String> values) {
     ...
     */
    public CompletableFuture<List<up.god.jooq.tables.pojos.LctFloor>> fetchBySCodeAsync(List<String> values) {
     ...
     */
    public CompletableFuture<List<up.god.jooq.tables.pojos.LctFloor>> fetchByJConfigAsync(List<String> values) {
     ...
     */
    public CompletableFuture<List<up.god.jooq.tables.pojos.LctFloor>> fetchByIOrderAsync(List<Integer> values) {
     ...
     */
    public CompletableFuture<List<up.god.jooq.tables.pojos.LctFloor>> fetchByRTentIdAsync(List<Long> values) {
     ...
     */
    public CompletableFuture<List<up.god.jooq.tables.pojos.LctFloor>> fetchByIsActiveAsync(List<Boolean> values) {
     ...
     */
    public CompletableFuture<List<up.god.jooq.tables.pojos.LctFloor>> fetchByZSigmaAsync(List<String> values) {
     ...
     */
    public CompletableFuture<List<up.god.jooq.tables.pojos.LctFloor>> fetchByZLanguageAsync(List<String> values) {
     ...
     */
    public CompletableFuture<List<up.god.jooq.tables.pojos.LctFloor>> fetchByZCreateByAsync(List<String> values) {
     ...
     */
    public CompletableFuture<List<up.god.jooq.tables.pojos.LctFloor>> fetchByZCreateTimeAsync(List<LocalDateTime> values) {
     ...
     */
    public CompletableFuture<List<up.god.jooq.tables.pojos.LctFloor>> fetchByZUpdateByAsync(List<String> values) {
     ...
     */
    public CompletableFuture<List<up.god.jooq.tables.pojos.LctFloor>> fetchByZUpdateTimeAsync(List<LocalDateTime> values) {
