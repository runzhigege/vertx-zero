...
public class SysNumber extends TableImpl<SysNumberRecord> {
    ...
    private static final long serialVersionUID = -1850075617;
     ...
     */
    public final TableField<SysNumberRecord, Long> PK_ID = createField("PK_ID", org.jooq.impl.SQLDataType.BIGINT.nullable(false).identity(true), this, "uniqueId,PK_ID");
     ...
     */
    @Override
    public Identity<SysNumberRecord, Long> getIdentity() {
        return Keys.IDENTITY_SYS_NUMBER;
    }
