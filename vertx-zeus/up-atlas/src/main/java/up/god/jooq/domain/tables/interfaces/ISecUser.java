...
*/
package up.god.jooq.domain.tables.interfaces;
...
public interface ISecUser extends Serializable {
     ...
     */
    public ISecUser setZCreateTime(Timestamp value);
     ...
     */
    public ISecUser setZUpdateTime(Timestamp value);
     ...
     */
    public void from(up.god.jooq.domain.tables.interfaces.ISecUser from);

    /**
     * Copy data into another generated Record/POJO implementing the common interface ISecUser
     */
    public <E extends up.god.jooq.domain.tables.interfaces.ISecUser> E into(E into);
    ...
    default ISecUser fromJson(io.vertx.core.json.JsonObject json) {
        ...
        // Omitting unrecognized type java.sql.Timestamp for column Z_CREATE_TIME!
        setZUpdateBy(json.getString("Z_UPDATE_BY"));
        // Omitting unrecognized type java.sql.Timestamp for column Z_UPDATE_TIME!
        return this;
    }
