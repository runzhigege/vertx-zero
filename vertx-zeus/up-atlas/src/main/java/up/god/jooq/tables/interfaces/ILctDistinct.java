...
public interface ILctDistinct extends Serializable {
     ...
     */
    public ILctDistinct setPkId(Long value);
     ...
     */
    public ILctDistinct setRCityId(Long value);
     ...
     */
    public void from(up.god.jooq.tables.interfaces.ILctDistinct from);

    /**
     * Copy data into another generated Record/POJO implementing the common interface ILctDistinct
     */
    public <E extends up.god.jooq.tables.interfaces.ILctDistinct> E into(E into);
