...
public interface ISysNumber extends Serializable {
     ...
     */
    public ISysNumber setPkId(Long value);
     ...
     */
    public void from(up.god.jooq.tables.interfaces.ISysNumber from);

    /**
     * Copy data into another generated Record/POJO implementing the common interface ISysNumber
     */
    public <E extends up.god.jooq.tables.interfaces.ISysNumber> E into(E into);
