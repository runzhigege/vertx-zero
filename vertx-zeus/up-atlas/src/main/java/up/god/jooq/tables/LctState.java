...
public class LctState extends TableImpl<LctStateRecord> {
    ...
    private static final long serialVersionUID = 380272593;
     ...
     */
    public final TableField<LctStateRecord, Long> PK_ID = createField("PK_ID", org.jooq.impl.SQLDataType.BIGINT.nullable(false).identity(true), this, "uniqueId,PK_ID");
     ...
     */
    public final TableField<LctStateRecord, Long> R_COUNTRY_ID = createField("R_COUNTRY_ID", org.jooq.impl.SQLDataType.BIGINT.nullable(false), this, "countryId,R_COUNTRY_ID");
     ...
     */
    @Override
    public Identity<LctStateRecord, Long> getIdentity() {
        return Keys.IDENTITY_LCT_STATE;
    }
