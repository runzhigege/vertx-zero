...
public class SysTabularDao extends DAOImpl<SysTabularRecord, up.god.jooq.tables.pojos.SysTabular, Long> implements VertxDAO<up.god.jooq.tables.records.SysTabularRecord,up.god.jooq.tables.pojos.SysTabular,java.lang.Long> {

    /**
     * Create a new SysTabularDao without any configuration
     */
    public SysTabularDao() {
        super(SysTabular.SYS_TABULAR, up.god.jooq.tables.pojos.SysTabular.class);
    }
    ...
    public SysTabularDao(Configuration configuration) {
        super(SysTabular.SYS_TABULAR, up.god.jooq.tables.pojos.SysTabular.class, configuration);
    }
     ...
     */
    @Override
    protected Long getId(up.god.jooq.tables.pojos.SysTabular object) {
     ...
     */
    public List<up.god.jooq.tables.pojos.SysTabular> fetchByPkId(Long... values) {
     ...
     */
    public up.god.jooq.tables.pojos.SysTabular fetchOneByPkId(Long value) {
     ...
     */
    public List<up.god.jooq.tables.pojos.SysTabular> fetchByTComment(String... values) {
     ...
     */
    public List<up.god.jooq.tables.pojos.SysTabular> fetchBySName(String... values) {
     ...
     */
    public List<up.god.jooq.tables.pojos.SysTabular> fetchBySCode(String... values) {
     ...
     */
    public List<up.god.jooq.tables.pojos.SysTabular> fetchBySSerial(String... values) {
     ...
     */
    public List<up.god.jooq.tables.pojos.SysTabular> fetchBySType(String... values) {
     ...
     */
    public List<up.god.jooq.tables.pojos.SysTabular> fetchByJConfig(String... values) {
     ...
     */
    public List<up.god.jooq.tables.pojos.SysTabular> fetchByIOrder(Integer... values) {
     ...
     */
    public List<up.god.jooq.tables.pojos.SysTabular> fetchByIsActive(Boolean... values) {
     ...
     */
    public List<up.god.jooq.tables.pojos.SysTabular> fetchByZSigma(String... values) {
     ...
     */
    public List<up.god.jooq.tables.pojos.SysTabular> fetchByZLanguage(String... values) {
     ...
     */
    public List<up.god.jooq.tables.pojos.SysTabular> fetchByZCreateBy(String... values) {
     ...
     */
    public List<up.god.jooq.tables.pojos.SysTabular> fetchByZCreateTime(LocalDateTime... values) {
     ...
     */
    public List<up.god.jooq.tables.pojos.SysTabular> fetchByZUpdateBy(String... values) {
     ...
     */
    public List<up.god.jooq.tables.pojos.SysTabular> fetchByZUpdateTime(LocalDateTime... values) {
     ...
     */
    public CompletableFuture<List<up.god.jooq.tables.pojos.SysTabular>> fetchByPkIdAsync(List<Long> values) {
     ...
     */
    public CompletableFuture<up.god.jooq.tables.pojos.SysTabular> fetchOneByPkIdAsync(Long value) {
     ...
     */
    public CompletableFuture<List<up.god.jooq.tables.pojos.SysTabular>> fetchByTCommentAsync(List<String> values) {
     ...
     */
    public CompletableFuture<List<up.god.jooq.tables.pojos.SysTabular>> fetchBySNameAsync(List<String> values) {
     ...
     */
    public CompletableFuture<List<up.god.jooq.tables.pojos.SysTabular>> fetchBySCodeAsync(List<String> values) {
     ...
     */
    public CompletableFuture<List<up.god.jooq.tables.pojos.SysTabular>> fetchBySSerialAsync(List<String> values) {
     ...
     */
    public CompletableFuture<List<up.god.jooq.tables.pojos.SysTabular>> fetchBySTypeAsync(List<String> values) {
     ...
     */
    public CompletableFuture<List<up.god.jooq.tables.pojos.SysTabular>> fetchByJConfigAsync(List<String> values) {
     ...
     */
    public CompletableFuture<List<up.god.jooq.tables.pojos.SysTabular>> fetchByIOrderAsync(List<Integer> values) {
     ...
     */
    public CompletableFuture<List<up.god.jooq.tables.pojos.SysTabular>> fetchByIsActiveAsync(List<Boolean> values) {
     ...
     */
    public CompletableFuture<List<up.god.jooq.tables.pojos.SysTabular>> fetchByZSigmaAsync(List<String> values) {
     ...
     */
    public CompletableFuture<List<up.god.jooq.tables.pojos.SysTabular>> fetchByZLanguageAsync(List<String> values) {
     ...
     */
    public CompletableFuture<List<up.god.jooq.tables.pojos.SysTabular>> fetchByZCreateByAsync(List<String> values) {
     ...
     */
    public CompletableFuture<List<up.god.jooq.tables.pojos.SysTabular>> fetchByZCreateTimeAsync(List<LocalDateTime> values) {
     ...
     */
    public CompletableFuture<List<up.god.jooq.tables.pojos.SysTabular>> fetchByZUpdateByAsync(List<String> values) {
     ...
     */
    public CompletableFuture<List<up.god.jooq.tables.pojos.SysTabular>> fetchByZUpdateTimeAsync(List<LocalDateTime> values) {
