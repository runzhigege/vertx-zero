...
public class SecUser extends TableImpl<SecUserRecord> {
    ...
    private static final long serialVersionUID = -161812112;
     ...
     */
    public final TableField<SecUserRecord, LocalDateTime> Z_CREATE_TIME = createField("Z_CREATE_TIME", org.jooq.impl.SQLDataType.LOCALDATETIME, this, "createTime,Z_CREATE_TIME");
     ...
     */
    public final TableField<SecUserRecord, LocalDateTime> Z_UPDATE_TIME = createField("Z_UPDATE_TIME", org.jooq.impl.SQLDataType.LOCALDATETIME, this, "updateTime,Z_UPDATE_TIME");
