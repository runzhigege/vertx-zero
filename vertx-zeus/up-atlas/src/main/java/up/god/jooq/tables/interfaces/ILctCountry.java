...
public interface ILctCountry extends Serializable {
     ...
     */
    public ILctCountry setPkId(Long value);
     ...
     */
    public ILctCountry setRCurrencyId(Long value);
     ...
     */
    public void from(up.god.jooq.tables.interfaces.ILctCountry from);

    /**
     * Copy data into another generated Record/POJO implementing the common interface ILctCountry
     */
    public <E extends up.god.jooq.tables.interfaces.ILctCountry> E into(E into);
