...
public class SysApp extends TableImpl<SysAppRecord> {
    ...
    private static final long serialVersionUID = -543563142;
     ...
     */
    public final TableField<SysAppRecord, Long> PK_ID = createField("PK_ID", org.jooq.impl.SQLDataType.BIGINT.nullable(false).identity(true), this, "uniqueId,PK_ID");
     ...
     */
    public final TableField<SysAppRecord, Integer> V_ESERVER_ID = createField("V_ESERVER_ID", org.jooq.impl.SQLDataType.INTEGER, this, "email = true时，关联Email Server的ID（软关联）,emailServer,V_ESERVER_ID");
     ...
     */
    @Override
    public Identity<SysAppRecord, Long> getIdentity() {
        return Keys.IDENTITY_SYS_APP;
    }
