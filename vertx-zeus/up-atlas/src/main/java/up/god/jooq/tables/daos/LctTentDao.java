...
public class LctTentDao extends DAOImpl<LctTentRecord, up.god.jooq.tables.pojos.LctTent, Long> implements VertxDAO<up.god.jooq.tables.records.LctTentRecord,up.god.jooq.tables.pojos.LctTent,java.lang.Long> {

    /**
     * Create a new LctTentDao without any configuration
     */
    public LctTentDao() {
        super(LctTent.LCT_TENT, up.god.jooq.tables.pojos.LctTent.class);
    }
    ...
    public LctTentDao(Configuration configuration) {
        super(LctTent.LCT_TENT, up.god.jooq.tables.pojos.LctTent.class, configuration);
    }
     ...
     */
    @Override
    protected Long getId(up.god.jooq.tables.pojos.LctTent object) {
     ...
     */
    public List<up.god.jooq.tables.pojos.LctTent> fetchByPkId(Long... values) {
     ...
     */
    public up.god.jooq.tables.pojos.LctTent fetchOneByPkId(Long value) {
     ...
     */
    public List<up.god.jooq.tables.pojos.LctTent> fetchBySName(String... values) {
     ...
     */
    public List<up.god.jooq.tables.pojos.LctTent> fetchBySCode(String... values) {
     ...
     */
    public List<up.god.jooq.tables.pojos.LctTent> fetchBySContact(String... values) {
     ...
     */
    public List<up.god.jooq.tables.pojos.LctTent> fetchBySManager(String... values) {
     ...
     */
    public List<up.god.jooq.tables.pojos.LctTent> fetchByJConfig(String... values) {
     ...
     */
    public List<up.god.jooq.tables.pojos.LctTent> fetchByIOrder(Integer... values) {
     ...
     */
    public List<up.god.jooq.tables.pojos.LctTent> fetchByRLocationId(Long... values) {
     ...
     */
    public List<up.god.jooq.tables.pojos.LctTent> fetchByRYardId(Long... values) {
     ...
     */
    public List<up.god.jooq.tables.pojos.LctTent> fetchByIsActive(Boolean... values) {
     ...
     */
    public List<up.god.jooq.tables.pojos.LctTent> fetchByZSigma(String... values) {
     ...
     */
    public List<up.god.jooq.tables.pojos.LctTent> fetchByZLanguage(String... values) {
     ...
     */
    public List<up.god.jooq.tables.pojos.LctTent> fetchByZCreateBy(String... values) {
     ...
     */
    public List<up.god.jooq.tables.pojos.LctTent> fetchByZCreateTime(LocalDateTime... values) {
     ...
     */
    public List<up.god.jooq.tables.pojos.LctTent> fetchByZUpdateBy(String... values) {
     ...
     */
    public List<up.god.jooq.tables.pojos.LctTent> fetchByZUpdateTime(LocalDateTime... values) {
     ...
     */
    public CompletableFuture<List<up.god.jooq.tables.pojos.LctTent>> fetchByPkIdAsync(List<Long> values) {
     ...
     */
    public CompletableFuture<up.god.jooq.tables.pojos.LctTent> fetchOneByPkIdAsync(Long value) {
     ...
     */
    public CompletableFuture<List<up.god.jooq.tables.pojos.LctTent>> fetchBySNameAsync(List<String> values) {
     ...
     */
    public CompletableFuture<List<up.god.jooq.tables.pojos.LctTent>> fetchBySCodeAsync(List<String> values) {
     ...
     */
    public CompletableFuture<List<up.god.jooq.tables.pojos.LctTent>> fetchBySContactAsync(List<String> values) {
     ...
     */
    public CompletableFuture<List<up.god.jooq.tables.pojos.LctTent>> fetchBySManagerAsync(List<String> values) {
     ...
     */
    public CompletableFuture<List<up.god.jooq.tables.pojos.LctTent>> fetchByJConfigAsync(List<String> values) {
     ...
     */
    public CompletableFuture<List<up.god.jooq.tables.pojos.LctTent>> fetchByIOrderAsync(List<Integer> values) {
     ...
     */
    public CompletableFuture<List<up.god.jooq.tables.pojos.LctTent>> fetchByRLocationIdAsync(List<Long> values) {
     ...
     */
    public CompletableFuture<List<up.god.jooq.tables.pojos.LctTent>> fetchByRYardIdAsync(List<Long> values) {
     ...
     */
    public CompletableFuture<List<up.god.jooq.tables.pojos.LctTent>> fetchByIsActiveAsync(List<Boolean> values) {
     ...
     */
    public CompletableFuture<List<up.god.jooq.tables.pojos.LctTent>> fetchByZSigmaAsync(List<String> values) {
     ...
     */
    public CompletableFuture<List<up.god.jooq.tables.pojos.LctTent>> fetchByZLanguageAsync(List<String> values) {
     ...
     */
    public CompletableFuture<List<up.god.jooq.tables.pojos.LctTent>> fetchByZCreateByAsync(List<String> values) {
     ...
     */
    public CompletableFuture<List<up.god.jooq.tables.pojos.LctTent>> fetchByZCreateTimeAsync(List<LocalDateTime> values) {
     ...
     */
    public CompletableFuture<List<up.god.jooq.tables.pojos.LctTent>> fetchByZUpdateByAsync(List<String> values) {
     ...
     */
    public CompletableFuture<List<up.god.jooq.tables.pojos.LctTent>> fetchByZUpdateTimeAsync(List<LocalDateTime> values) {
