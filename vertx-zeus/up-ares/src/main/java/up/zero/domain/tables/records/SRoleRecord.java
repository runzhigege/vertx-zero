...
public class SRoleRecord extends UpdatableRecordImpl<SRoleRecord> implements Record9<String, String, String, Boolean, String, String, String, Boolean, String>, ISRole {
    ...
    private static final long serialVersionUID = -1759224023;
     ...
     */
    public SRoleRecord(String key, String name, String code, Boolean super_, String comment, String sigma, String language, Boolean active, String metadata) {
        super(SRole.S_ROLE);
