...
public class SysTabularDao extends DAOImpl<SysTabularRecord, up.god.domain.tables.pojos.SysTabular, String> implements VertxDAO<up.god.domain.tables.records.SysTabularRecord,up.god.domain.tables.pojos.SysTabular,java.lang.String> {
     ...
     */
    @Override
    protected String getId(up.god.domain.tables.pojos.SysTabular object) {
     ...
     */
    public List<up.god.domain.tables.pojos.SysTabular> fetchByPkId(String... values) {
     ...
     */
    public up.god.domain.tables.pojos.SysTabular fetchOneByPkId(String value) {
     ...
     */
    public CompletableFuture<List<up.god.domain.tables.pojos.SysTabular>> fetchByPkIdAsync(List<String> values) {
     ...
     */
    public CompletableFuture<up.god.domain.tables.pojos.SysTabular> fetchOneByPkIdAsync(String value) {
