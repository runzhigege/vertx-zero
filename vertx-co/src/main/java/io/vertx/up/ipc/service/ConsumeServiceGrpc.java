...
public final class ConsumeServiceGrpc {
  ...
  public static final String SERVICE_NAME = "io.vertx.up.ipc.service.ConsumeService";

  // Static method descriptors that strictly reflect the proto.
  @io.grpc.ExperimentalApi("https://github.com/grpc/grpc-java/issues/1901")
  public static final io.grpc.MethodDescriptor<io.vertx.up.ipc.eon.StreamServerRequest,
      io.vertx.up.ipc.eon.StreamServerResponse> METHOD_OUTPUT_CALL =
      io.grpc.MethodDescriptor.create(
          io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING,
          generateFullMethodName(
              "io.vertx.up.ipc.service.ConsumeService", "OutputCall"),
          io.grpc.protobuf.ProtoUtils.marshaller(io.vertx.up.ipc.eon.StreamServerRequest.getDefaultInstance()),
  ...
  public static abstract class ConsumeServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public io.grpc.stub.StreamObserver<io.vertx.up.ipc.eon.StreamServerRequest> outputCall(
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncBidiStreamingCall(
              new MethodHandlers<
                io.vertx.up.ipc.eon.StreamServerRequest,
  ...
  public static abstract class ConsumeServiceVertxImplBase implements io.grpc.BindableService {
    ...
    public void outputCall(
        io.vertx.grpc.GrpcBidiExchange<io.vertx.up.ipc.eon.StreamServerRequest, io.vertx.up.ipc.eon.StreamServerResponse> exchange) {
  ...
  public static final class ConsumeServiceVertxStub extends io.grpc.stub.AbstractStub<ConsumeServiceVertxStub> {
    ...
    public void outputCall(io.vertx.core.Handler<
        io.vertx.grpc.GrpcBidiExchange<io.vertx.up.ipc.eon.StreamServerResponse, io.vertx.up.ipc.eon.StreamServerRequest>> handler) {
  ...
  private static final class VertxMethodHandlers<Req, Resp> implements
    ...
    public io.grpc.stub.StreamObserver<Req> invoke(
      ...
      switch (methodId) {
        case METHODID_OUTPUT_CALL:
          io.vertx.grpc.GrpcReadStream<io.vertx.up.ipc.eon.StreamServerRequest> request0 = io.vertx.grpc.GrpcReadStream.<io.vertx.up.ipc.eon.StreamServerRequest>create();
          serviceImpl.outputCall(
             io.vertx.grpc.GrpcBidiExchange.<io.vertx.up.ipc.eon.StreamServerRequest, io.vertx.up.ipc.eon.StreamServerResponse>create(
               request0,
               (io.grpc.stub.StreamObserver<io.vertx.up.ipc.eon.StreamServerResponse>) responseObserver));
