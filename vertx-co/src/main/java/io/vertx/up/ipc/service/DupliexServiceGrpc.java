...
public final class DupliexServiceGrpc {
  ...
  public static final String SERVICE_NAME = "io.vertx.up.ipc.service.DupliexService";

  // Static method descriptors that strictly reflect the proto.
  @io.grpc.ExperimentalApi("https://github.com/grpc/grpc-java/issues/1901")
  public static final io.grpc.MethodDescriptor<io.vertx.up.ipc.eon.StreamClientRequest,
      io.vertx.up.ipc.eon.StreamServerResponse> METHOD_DUPLIEX_CALL =
      io.grpc.MethodDescriptor.create(
          io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING,
          generateFullMethodName(
              "io.vertx.up.ipc.service.DupliexService", "DupliexCall"),
          io.grpc.protobuf.ProtoUtils.marshaller(io.vertx.up.ipc.eon.StreamClientRequest.getDefaultInstance()),
          io.grpc.protobuf.ProtoUtils.marshaller(io.vertx.up.ipc.eon.StreamServerResponse.getDefaultInstance()));
  ...
  public static abstract class DupliexServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public io.grpc.stub.StreamObserver<io.vertx.up.ipc.eon.StreamClientRequest> dupliexCall(
        io.grpc.stub.StreamObserver<io.vertx.up.ipc.eon.StreamServerResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncBidiStreamingCall(
              new MethodHandlers<
                io.vertx.up.ipc.eon.StreamClientRequest,
                io.vertx.up.ipc.eon.StreamServerResponse>(
  ...
  public static abstract class DupliexServiceVertxImplBase implements io.grpc.BindableService {
    ...
    public void dupliexCall(
        io.vertx.grpc.GrpcBidiExchange<io.vertx.up.ipc.eon.StreamClientRequest, io.vertx.up.ipc.eon.StreamServerResponse> exchange) {
  ...
  public static final class DupliexServiceVertxStub extends io.grpc.stub.AbstractStub<DupliexServiceVertxStub> {
    ...
    public void dupliexCall(io.vertx.core.Handler<
        io.vertx.grpc.GrpcBidiExchange<io.vertx.up.ipc.eon.StreamServerResponse, io.vertx.up.ipc.eon.StreamClientRequest>> handler) {
      final io.vertx.grpc.GrpcReadStream<io.vertx.up.ipc.eon.StreamServerResponse> readStream =
          io.vertx.grpc.GrpcReadStream.<io.vertx.up.ipc.eon.StreamServerResponse>create();
  ...
  private static final class VertxMethodHandlers<Req, Resp> implements
    ...
    public io.grpc.stub.StreamObserver<Req> invoke(
      ...
      switch (methodId) {
        case METHODID_DUPLIEX_CALL:
          io.vertx.grpc.GrpcReadStream<io.vertx.up.ipc.eon.StreamClientRequest> request0 = io.vertx.grpc.GrpcReadStream.<io.vertx.up.ipc.eon.StreamClientRequest>create();
          serviceImpl.dupliexCall(
             io.vertx.grpc.GrpcBidiExchange.<io.vertx.up.ipc.eon.StreamClientRequest, io.vertx.up.ipc.eon.StreamServerResponse>create(
               request0,
               (io.grpc.stub.StreamObserver<io.vertx.up.ipc.eon.StreamServerResponse>) responseObserver));
  ...
  private static final class DupliexServiceDescriptorSupplier implements io.grpc.protobuf.ProtoFileDescriptorSupplier {
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return io.vertx.up.ipc.service.UpIpcService.getDescriptor();
    }
  }
