...
public final class UnityServiceGrpc {
  ...
  public static final String SERVICE_NAME = "io.vertx.up.ipc.service.UnityService";

  // Static method descriptors that strictly reflect the proto.
  @io.grpc.ExperimentalApi("https://github.com/grpc/grpc-java/issues/1901")
  public static final io.grpc.MethodDescriptor<io.vertx.up.ipc.eon.IpcRequest,
      io.vertx.up.ipc.eon.IpcResponse> METHOD_UNITY_CALL =
      io.grpc.MethodDescriptor.create(
          io.grpc.MethodDescriptor.MethodType.UNARY,
          generateFullMethodName(
              "io.vertx.up.ipc.service.UnityService", "UnityCall"),
          io.grpc.protobuf.ProtoUtils.marshaller(io.vertx.up.ipc.eon.IpcRequest.getDefaultInstance()),
          io.grpc.protobuf.ProtoUtils.marshaller(io.vertx.up.ipc.eon.IpcResponse.getDefaultInstance()));
  ...
  public static abstract class UnityServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void unityCall(io.vertx.up.ipc.eon.IpcRequest request,
        io.grpc.stub.StreamObserver<io.vertx.up.ipc.eon.IpcResponse> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                io.vertx.up.ipc.eon.IpcRequest,
                io.vertx.up.ipc.eon.IpcResponse>(
  ...
  public static final class UnityServiceBlockingStub extends io.grpc.stub.AbstractStub<UnityServiceBlockingStub> {
     ...
     * </pre>
     */
    public io.vertx.up.ipc.eon.IpcResponse unityCall(io.vertx.up.ipc.eon.IpcRequest request) {
  ...
  public static final class UnityServiceFutureStub extends io.grpc.stub.AbstractStub<UnityServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<io.vertx.up.ipc.eon.IpcResponse> unityCall(
        io.vertx.up.ipc.eon.IpcRequest request) {
  ...
  public static abstract class UnityServiceVertxImplBase implements io.grpc.BindableService {
     ...
     */
    public void unityCall(io.vertx.up.ipc.eon.IpcRequest request,
        io.vertx.core.Future<io.vertx.up.ipc.eon.IpcResponse> response) {
  ...
  public static final class UnityServiceVertxStub extends io.grpc.stub.AbstractStub<UnityServiceVertxStub> {
     ...
     */
    public void unityCall(io.vertx.up.ipc.eon.IpcRequest request,
        io.vertx.core.Handler<io.vertx.core.AsyncResult<io.vertx.up.ipc.eon.IpcResponse>> response) {
      asyncUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_UNITY_CALL:
          serviceImpl.unityCall((io.vertx.up.ipc.eon.IpcRequest) request,
              (io.grpc.stub.StreamObserver<io.vertx.up.ipc.eon.IpcResponse>) responseObserver);
          break;
        default:
  ...
  private static final class VertxMethodHandlers<Req, Resp> implements
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_UNITY_CALL:
          serviceImpl.unityCall((io.vertx.up.ipc.eon.IpcRequest) request,
              (io.vertx.core.Future<io.vertx.up.ipc.eon.IpcResponse>) io.vertx.core.Future.<io.vertx.up.ipc.eon.IpcResponse>future().setHandler(ar -> {
                if (ar.succeeded()) {
                  ((io.grpc.stub.StreamObserver<io.vertx.up.ipc.eon.IpcResponse>) responseObserver).onNext(ar.result());
