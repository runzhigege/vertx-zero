...
public final class ProduceServiceGrpc {
  ...
  public static final String SERVICE_NAME = "io.vertx.up.ipc.service.ProduceService";

  // Static method descriptors that strictly reflect the proto.
  @io.grpc.ExperimentalApi("https://github.com/grpc/grpc-java/issues/1901")
  public static final io.grpc.MethodDescriptor<io.vertx.up.ipc.eon.StreamClientRequest,
      io.vertx.up.ipc.eon.StreamClientResponse> METHOD_INPUT_CALL =
      io.grpc.MethodDescriptor.create(
          io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING,
          generateFullMethodName(
              "io.vertx.up.ipc.service.ProduceService", "InputCall"),
          io.grpc.protobuf.ProtoUtils.marshaller(io.vertx.up.ipc.eon.StreamClientRequest.getDefaultInstance()),
          io.grpc.protobuf.ProtoUtils.marshaller(io.vertx.up.ipc.eon.StreamClientResponse.getDefaultInstance()));
  ...
  public static abstract class ProduceServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public io.grpc.stub.StreamObserver<io.vertx.up.ipc.eon.StreamClientRequest> inputCall(
        io.grpc.stub.StreamObserver<io.vertx.up.ipc.eon.StreamClientResponse> responseObserver) {
          ...
          .addMethod(
            ...
            asyncBidiStreamingCall(
              new MethodHandlers<
                ...
                io.vertx.up.ipc.eon.StreamClientResponse>(
  ...
  public static abstract class ProduceServiceVertxImplBase implements io.grpc.BindableService {
    ...
    public void inputCall(
        io.vertx.grpc.GrpcBidiExchange<io.vertx.up.ipc.eon.StreamClientRequest, io.vertx.up.ipc.eon.StreamClientResponse> exchange) {
  ...
  public static final class ProduceServiceVertxStub extends io.grpc.stub.AbstractStub<ProduceServiceVertxStub> {
    ...
    public void inputCall(io.vertx.core.Handler<
        io.vertx.grpc.GrpcBidiExchange<io.vertx.up.ipc.eon.StreamClientResponse, io.vertx.up.ipc.eon.StreamClientRequest>> handler) {
      final io.vertx.grpc.GrpcReadStream<io.vertx.up.ipc.eon.StreamClientResponse> readStream =
          io.vertx.grpc.GrpcReadStream.<io.vertx.up.ipc.eon.StreamClientResponse>create();
      ...
      switch (methodId) {
        case METHODID_INPUT_CALL:
          ...
          serviceImpl.inputCall(
             io.vertx.grpc.GrpcBidiExchange.<io.vertx.up.ipc.eon.StreamClientRequest, io.vertx.up.ipc.eon.StreamClientResponse>create(
               request0,
               (io.grpc.stub.StreamObserver<io.vertx.up.ipc.eon.StreamClientResponse>) responseObserver));
