...
public class UxPool {
    ...
    public <K, V> Future<Kv<K, V>> put(final K key, final V value) {
        return Ux.<Kv<K, V>>thenGeneric(future -> this.client.put(key, value, res -> {
    ...
    public <K, V> Future<Kv<K, V>> put(final K key, final V value, int expiredSecs) {
        return Ux.<Kv<K, V>>thenGeneric(future -> this.client.<K, V>put(key, value, expiredSecs, res -> {
    ...
    public <K, V> Future<Kv<K, V>> remove(final K key) {
        return Ux.<Kv<K, V>>thenGeneric(future -> this.client.<K, V>remove(key, res -> {
