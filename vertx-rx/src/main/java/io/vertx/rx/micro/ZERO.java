...
interface Info {
    String RX_SERVERS = "[ ZERO ] ( Rx Server ) {0} (id = {1}) Agent has deployed Rx Server on {2}.";

    String MAPPED_ROUTE = "[ ZERO ] ( Uri Register ) \"{1}\" has been deployed by {0}, Options = {2}.";

    String RX_LISTEN = "[ ZERO ] ( Rx Server ) {0} Rx Server has been started successfully. Endpoint: {1}.";
}
