...
public interface IECustomer extends Serializable {
     ...
     */
    public void from(cn.vertxup.hr.domain.tables.interfaces.IECustomer from);

    /**
     * Copy data into another generated Record/POJO implementing the common interface IECustomer
     */
    public <E extends cn.vertxup.hr.domain.tables.interfaces.IECustomer> E into(E into);
