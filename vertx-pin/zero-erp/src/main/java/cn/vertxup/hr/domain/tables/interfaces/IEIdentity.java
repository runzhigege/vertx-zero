...
public interface IEIdentity extends Serializable {
     ...
     */
    public void from(cn.vertxup.hr.domain.tables.interfaces.IEIdentity from);

    /**
     * Copy data into another generated Record/POJO implementing the common interface IEIdentity
     */
    public <E extends cn.vertxup.hr.domain.tables.interfaces.IEIdentity> E into(E into);
