...
*/
package cn.vertxup.hr.domain.tables.interfaces;
...
public interface IEEmployee extends Serializable {
     ...
     */
    public void from(cn.vertxup.hr.domain.tables.interfaces.IEEmployee from);

    /**
     * Copy data into another generated Record/POJO implementing the common interface IEEmployee
     */
    public <E extends cn.vertxup.hr.domain.tables.interfaces.IEEmployee> E into(E into);
