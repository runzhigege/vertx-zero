...
public class RUserRoleDao extends DAOImpl<RUserRoleRecord, cn.vertxup.domain.tables.pojos.RUserRole, Record2<String, String>> implements VertxDAO<cn.vertxup.domain.tables.records.RUserRoleRecord,cn.vertxup.domain.tables.pojos.RUserRole,org.jooq.Record2<java.lang.String, java.lang.String>> {

    /**
     * Create a new RUserRoleDao without any configuration
     */
    public RUserRoleDao() {
        super(RUserRole.R_USER_ROLE, cn.vertxup.domain.tables.pojos.RUserRole.class);
    }
    ...
    public RUserRoleDao(Configuration configuration) {
        super(RUserRole.R_USER_ROLE, cn.vertxup.domain.tables.pojos.RUserRole.class, configuration);
    }
     ...
     */
    @Override
    protected Record2<String, String> getId(cn.vertxup.domain.tables.pojos.RUserRole object) {
     ...
     */
    public List<cn.vertxup.domain.tables.pojos.RUserRole> fetchByUserId(String... values) {
     ...
     */
    public List<cn.vertxup.domain.tables.pojos.RUserRole> fetchByRoleId(String... values) {
