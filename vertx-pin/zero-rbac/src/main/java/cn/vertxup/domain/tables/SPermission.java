...
public class SPermission extends TableImpl<SPermissionRecord> {
    ...
    private static final long serialVersionUID = 1271343451;

    /**
     * The reference instance of <code>UP_RBAC.S_PERMISSION</code>
     */
    ...
    /**
     * The column <code>UP_RBAC.S_PERMISSION.KEY</code>. 「key」- 权限ID
     */
    ...
    /**
     * The column <code>UP_RBAC.S_PERMISSION.NAME</code>. 「name」- 权限名称
     */
    ...
    /**
     * The column <code>UP_RBAC.S_PERMISSION.CODE</code>. 「code」- 权限系统码
     */
    ...
    /**
     * The column <code>UP_RBAC.S_PERMISSION.PRIORITY</code>. 「priority」- 权限优先级：角色优先、组优先、用户优先
     */
    ...
    /**
     * The column <code>UP_RBAC.S_PERMISSION.MODE</code>. 「mode」- 继承、限制、时域、指定
     */
    ...
    /**
     * The column <code>UP_RBAC.S_PERMISSION.CATEGORY</code>. 「category」- 组类型
     */
    ...
    /**
     * The column <code>UP_RBAC.S_PERMISSION.SIGMA</code>. 「sigma」- 绑定的统一标识
     */
    ...
    /**
     * The column <code>UP_RBAC.S_PERMISSION.LANGUAGE</code>. 「language」- 使用的语言
     */
    ...
    /**
     * The column <code>UP_RBAC.S_PERMISSION.ACTIVE</code>. 「active」- 是否启用
     */
    ...
    /**
     * The column <code>UP_RBAC.S_PERMISSION.METADATA</code>. 「metadata」- 附加配置数据
     */
    ...
    /**
     * The column <code>UP_RBAC.S_PERMISSION.CREATED_AT</code>. 「createdAt」- 创建时间
     */
    ...
    /**
     * The column <code>UP_RBAC.S_PERMISSION.CREATED_BY</code>. 「createdBy」- 创建人
     */
    ...
    /**
     * The column <code>UP_RBAC.S_PERMISSION.UPDATED_AT</code>. 「updatedAt」- 更新时间
     */
    ...
    /**
     * The column <code>UP_RBAC.S_PERMISSION.UPDATED_BY</code>. 「updatedBy」- 更新人
     */
    ...
    /**
     * Create a <code>UP_RBAC.S_PERMISSION</code> table reference
     */
    public SPermission() {
    ...
    /**
     * Create an aliased <code>UP_RBAC.S_PERMISSION</code> table reference
     */
