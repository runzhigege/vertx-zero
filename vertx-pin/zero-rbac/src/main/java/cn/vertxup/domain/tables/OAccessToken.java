...
public class OAccessToken extends TableImpl<OAccessTokenRecord> {
    ...
    /**
     * The reference instance of <code>DB_ORIGIN_X.O_ACCESS_TOKEN</code>
     */
    public static final OAccessToken O_ACCESS_TOKEN = new OAccessToken();
    private static final long serialVersionUID = 1694964775;
    /**
     * The column <code>DB_ORIGIN_X.O_ACCESS_TOKEN.KEY</code>. 「key」- 令牌主键
     */
    ...
    /**
     * The column <code>DB_ORIGIN_X.O_ACCESS_TOKEN.TOKEN</code>. 「token」- 用户的Token信息
     */
    ...
    /**
     * The column <code>DB_ORIGIN_X.O_ACCESS_TOKEN.AUTH</code>. 「auth」- 用户的ID的 byte[] 信息
     */
    ...
    /**
     * The column <code>DB_ORIGIN_X.O_ACCESS_TOKEN.EXPIRED_TIME</code>. 「expiredTime」- 用户的Token过期时间
     */
    ...
    /**
     * The column <code>DB_ORIGIN_X.O_ACCESS_TOKEN.REFRESH_TOKEN</code>. 「refreshToken」- 用户的刷新令牌
     */
    ...
    /**
     * The column <code>DB_ORIGIN_X.O_ACCESS_TOKEN.LANGUAGE</code>. 「language」- 使用的语言
     */
    ...
    /**
     * The column <code>DB_ORIGIN_X.O_ACCESS_TOKEN.ACTIVE</code>. 「active」- 是否启用
     */
    ...
    /**
     * The column <code>DB_ORIGIN_X.O_ACCESS_TOKEN.METADATA</code>. 「metadata」- 附加配置数据
     */
    ...
    /**
     * The column <code>DB_ORIGIN_X.O_ACCESS_TOKEN.CREATED_AT</code>. 「createdAt」- 创建时间
     */
    ...
    /**
     * The column <code>DB_ORIGIN_X.O_ACCESS_TOKEN.CREATED_BY</code>. 「createdBy」- 创建人
     */
    ...
    /**
     * Create a <code>DB_ORIGIN_X.O_ACCESS_TOKEN</code> table reference
     */
    public OAccessToken() {
    ...
    /**
     * Create an aliased <code>DB_ORIGIN_X.O_ACCESS_TOKEN</code> table reference
     */
