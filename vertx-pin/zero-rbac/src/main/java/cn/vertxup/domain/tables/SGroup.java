...
public class SGroup extends TableImpl<SGroupRecord> {
    ...
    private static final long serialVersionUID = 1646999520;

    /**
     * The reference instance of <code>UP_RBAC.S_GROUP</code>
     */
    ...
    /**
     * The column <code>UP_RBAC.S_GROUP.KEY</code>. 「key」- 组ID
     */
    ...
    /**
     * The column <code>UP_RBAC.S_GROUP.MODEL_ID</code>. 「modelId」- 组所关联的模型identifier，用于描述
     */
    ...
    /**
     * The column <code>UP_RBAC.S_GROUP.MODEL_KEY</code>. 「modelKey」- 组所关联的模型记录ID，用于描述哪一个Model中的记录
     */
    ...
    /**
     * The column <code>UP_RBAC.S_GROUP.CATEGORY</code>. 「category」- 组类型
     */
    ...
    /**
     * The column <code>UP_RBAC.S_GROUP.SIGMA</code>. 「sigma」- 用户组绑定的统一标识
     */
    ...
    /**
     * The column <code>UP_RBAC.S_GROUP.LANGUAGE</code>. 「language」- 使用的语言
     */
    ...
    /**
     * The column <code>UP_RBAC.S_GROUP.CREATED_AT</code>. 「createdAt」- 创建时间
     */
    ...
    /**
     * The column <code>UP_RBAC.S_GROUP.CREATED_BY</code>. 「createdBy」- 创建人
     */
    ...
    /**
     * The column <code>UP_RBAC.S_GROUP.UPDATED_AT</code>. 「updatedAt」- 更新时间
     */
    ...
    /**
     * The column <code>UP_RBAC.S_GROUP.UPDATED_BY</code>. 「updatedBy」- 更新人
     */
    ...
    /**
     * Create a <code>UP_RBAC.S_GROUP</code> table reference
     */
    public SGroup() {
    ...
    /**
     * Create an aliased <code>UP_RBAC.S_GROUP</code> table reference
     */
