...
public class RGroupRoleDao extends DAOImpl<RGroupRoleRecord, cn.vertxup.domain.tables.pojos.RGroupRole, Record2<String, String>> implements VertxDAO<cn.vertxup.domain.tables.records.RGroupRoleRecord,cn.vertxup.domain.tables.pojos.RGroupRole,org.jooq.Record2<java.lang.String, java.lang.String>> {

    /**
     * Create a new RGroupRoleDao without any configuration
     */
    public RGroupRoleDao() {
        super(RGroupRole.R_GROUP_ROLE, cn.vertxup.domain.tables.pojos.RGroupRole.class);
    }
    ...
    public RGroupRoleDao(Configuration configuration) {
        super(RGroupRole.R_GROUP_ROLE, cn.vertxup.domain.tables.pojos.RGroupRole.class, configuration);
    }
     ...
     */
    @Override
    protected Record2<String, String> getId(cn.vertxup.domain.tables.pojos.RGroupRole object) {
     ...
     */
    public List<cn.vertxup.domain.tables.pojos.RGroupRole> fetchByGroupId(String... values) {
     ...
     */
    public List<cn.vertxup.domain.tables.pojos.RGroupRole> fetchByRoleId(String... values) {
