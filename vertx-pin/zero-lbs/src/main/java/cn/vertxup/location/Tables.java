...
public class Tables {
     ...
     */
    public static final LCity L_CITY = cn.vertxup.location.tables.LCity.L_CITY;

    /**
     * The table <code>DB_ETERNAL.L_COUNTRY</code>.
     */
    public static final LCountry L_COUNTRY = cn.vertxup.location.tables.LCountry.L_COUNTRY;

    /**
     * The table <code>DB_ETERNAL.L_FLOOR</code>.
     */
    public static final LFloor L_FLOOR = cn.vertxup.location.tables.LFloor.L_FLOOR;

    /**
     * The table <code>DB_ETERNAL.L_LOCATION</code>.
     */
    public static final LLocation L_LOCATION = cn.vertxup.location.tables.LLocation.L_LOCATION;

    /**
     * The table <code>DB_ETERNAL.L_REGION</code>.
     */
    public static final LRegion L_REGION = cn.vertxup.location.tables.LRegion.L_REGION;

    /**
     * The table <code>DB_ETERNAL.L_STATE</code>.
     */
    public static final LState L_STATE = cn.vertxup.location.tables.LState.L_STATE;

    /**
     * The table <code>DB_ETERNAL.L_TENT</code>.
     */
    public static final LTent L_TENT = cn.vertxup.location.tables.LTent.L_TENT;

    /**
     * The table <code>DB_ETERNAL.L_YARD</code>.
     */
    public static final LYard L_YARD = cn.vertxup.location.tables.LYard.L_YARD;
}
