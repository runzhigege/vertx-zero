...
public class XCategoryDao extends DAOImpl<XCategoryRecord, cn.vertxup.ambient.tables.pojos.XCategory, String> implements VertxDAO<cn.vertxup.ambient.tables.records.XCategoryRecord,cn.vertxup.ambient.tables.pojos.XCategory,java.lang.String> {

    /**
     * Create a new XCategoryDao without any configuration
     */
    public XCategoryDao() {
        super(XCategory.X_CATEGORY, cn.vertxup.ambient.tables.pojos.XCategory.class);
    }
    ...
    public XCategoryDao(Configuration configuration) {
        super(XCategory.X_CATEGORY, cn.vertxup.ambient.tables.pojos.XCategory.class, configuration);
    }
     ...
     */
    @Override
    protected String getId(cn.vertxup.ambient.tables.pojos.XCategory object) {
     ...
     */
    public List<cn.vertxup.ambient.tables.pojos.XCategory> fetchByKey(String... values) {
     ...
     */
    public cn.vertxup.ambient.tables.pojos.XCategory fetchOneByKey(String value) {
     ...
     */
    public List<cn.vertxup.ambient.tables.pojos.XCategory> fetchByName(String... values) {
     ...
     */
    public List<cn.vertxup.ambient.tables.pojos.XCategory> fetchByCode(String... values) {
     ...
     */
    public List<cn.vertxup.ambient.tables.pojos.XCategory> fetchByIcon(String... values) {
     ...
     */
    public List<cn.vertxup.ambient.tables.pojos.XCategory> fetchByType(String... values) {
     ...
     */
    public List<cn.vertxup.ambient.tables.pojos.XCategory> fetchBySort(Integer... values) {
     ...
     */
    public List<cn.vertxup.ambient.tables.pojos.XCategory> fetchByLeaf(Boolean... values) {
     ...
     */
    public List<cn.vertxup.ambient.tables.pojos.XCategory> fetchByParentId(String... values) {
     ...
     */
    public List<cn.vertxup.ambient.tables.pojos.XCategory> fetchByIdentifier(String... values) {
     ...
     */
    public List<cn.vertxup.ambient.tables.pojos.XCategory> fetchByComment(String... values) {
     ...
     */
    public List<cn.vertxup.ambient.tables.pojos.XCategory> fetchByMetadata(String... values) {
     ...
     */
    public List<cn.vertxup.ambient.tables.pojos.XCategory> fetchByLanguage(String... values) {
     ...
     */
    public CompletableFuture<List<cn.vertxup.ambient.tables.pojos.XCategory>> fetchByKeyAsync(List<String> values) {
     ...
     */
    public CompletableFuture<cn.vertxup.ambient.tables.pojos.XCategory> fetchOneByKeyAsync(String value) {
     ...
     */
    public CompletableFuture<List<cn.vertxup.ambient.tables.pojos.XCategory>> fetchByNameAsync(List<String> values) {
     ...
     */
    public CompletableFuture<List<cn.vertxup.ambient.tables.pojos.XCategory>> fetchByCodeAsync(List<String> values) {
     ...
     */
    public CompletableFuture<List<cn.vertxup.ambient.tables.pojos.XCategory>> fetchByIconAsync(List<String> values) {
     ...
     */
    public CompletableFuture<List<cn.vertxup.ambient.tables.pojos.XCategory>> fetchByTypeAsync(List<String> values) {
     ...
     */
    public CompletableFuture<List<cn.vertxup.ambient.tables.pojos.XCategory>> fetchBySortAsync(List<Integer> values) {
     ...
     */
    public CompletableFuture<List<cn.vertxup.ambient.tables.pojos.XCategory>> fetchByLeafAsync(List<Boolean> values) {
     ...
     */
    public CompletableFuture<List<cn.vertxup.ambient.tables.pojos.XCategory>> fetchByParentIdAsync(List<String> values) {
     ...
     */
    public CompletableFuture<List<cn.vertxup.ambient.tables.pojos.XCategory>> fetchByIdentifierAsync(List<String> values) {
     ...
     */
    public CompletableFuture<List<cn.vertxup.ambient.tables.pojos.XCategory>> fetchByCommentAsync(List<String> values) {
     ...
     */
    public CompletableFuture<List<cn.vertxup.ambient.tables.pojos.XCategory>> fetchByMetadataAsync(List<String> values) {
     ...
     */
    public CompletableFuture<List<cn.vertxup.ambient.tables.pojos.XCategory>> fetchByLanguageAsync(List<String> values) {
