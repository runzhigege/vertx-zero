...
public interface IXAttachment extends Serializable {
     ...
     */
    public void from(cn.vertxup.ambient.tables.interfaces.IXAttachment from);

    /**
     * Copy data into another generated Record/POJO implementing the common interface IXAttachment
     */
    public <E extends cn.vertxup.ambient.tables.interfaces.IXAttachment> E into(E into);
