...
public interface IXTabular extends Serializable {
    ...
    /**
     * Setter for <code>DB_ETERNAL.X_TABULAR.METADATA</code>. 「metadata」-扩展配置信息
     */
    public IXTabular setMetadata(String value);

    /**
     * Getter for <code>DB_ETERNAL.X_TABULAR.METADATA</code>. 「metadata」-扩展配置信息
     */
     ...
     */
    public void from(cn.vertxup.ambient.tables.interfaces.IXTabular from);

    /**
     * Copy data into another generated Record/POJO implementing the common interface IXTabular
     */
    public <E extends cn.vertxup.ambient.tables.interfaces.IXTabular> E into(E into);
